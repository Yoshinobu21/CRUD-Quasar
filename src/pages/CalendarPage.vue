<template>
  <div class="subcontent">
    ...
    <div style="display: flex; justify-content: center; align-items: center; flex-wrap: nowrap;">
      <q-select v-model="country" label="Pick a Country" outlined dense options-dense map-options emit-value
        :options="countriesList" class="button" style="min-width: 320px;" />
    </div>
    ...
    <div class="row justify-center">
      <div style="display: flex; max-width: 800px; width: 100%;">
        <q-calendar-month ref="calendar" v-model="selectedDate" animated bordered focusable hoverable no-active-date
          :day-min-height="60" :day-height="0" :locale="locale" @change="onChange" @moved="onMoved"
